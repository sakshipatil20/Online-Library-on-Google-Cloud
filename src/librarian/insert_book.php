	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<legend>Enter book details</legend>
				...
				<div class="icon">
					<input class="b-price" type="number" name="b_price" placeholder="Credits" required />
				</div>
				...
				<div class="icon">
					<input class="b-copies" type="text" name="b_link" placeholder="Link" required />
				</div>
	...
	<?php
		if(isset($_POST['b_add']))
		{
			...
			else
			{
				...
				$query->bind_param("ssssdds", $_POST['b_isbn'], $_POST['b_title'], $_POST['b_author'], $_POST['b_category'], $_POST['b_price'], $_POST['b_copies'], $_POST['b_link']);
